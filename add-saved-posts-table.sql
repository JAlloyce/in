-- Add Missing saved_posts Table
-- This script creates the saved_posts table that is needed for the Saved.jsx functionality
...
-- Add missing count columns to posts table if they don't exist
DO $$ 
BEGIN
...
-- Add missing count columns to profiles table if they don't exist
DO $$ 
BEGIN
...
-- Add missing count columns to communities table if they don't exist
DO $$ 
BEGIN
